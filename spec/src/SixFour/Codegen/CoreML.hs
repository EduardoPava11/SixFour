...
-- | Emit the PyTorch @nn.Module@ source for the look-NN (the dormant CoreML/ANE distillation path).
...
-- | Emit the coremltools driver script that builds the @.mlpackage@ from the Torch module.
