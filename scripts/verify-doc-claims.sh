...
check "Native header declares all 30 distinct s4_* symbols (27 shipped + 3 tooling)" \
  test "$(grep -hoE 's4_[a-z_0-9]+' Native/include/sixfour_native.h | sort -u | wc -l | tr -d ' ')" -eq 30
