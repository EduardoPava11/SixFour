...
| board-q16-unported | new | Port `Spec.BoardQ16` → Zig `s4_board_q16` + Swift `AtlasBoard.histogram` mass path; gate `lawCountsOrderIndependent` (closes float leak at policy argmax) | high | **yes** |
